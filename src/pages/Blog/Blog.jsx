  ...
  return (
    <>
      <h2 className="text-4xl font-bold text-center mt-20">
        The React is Awesome & !!!Fun
      </h2>

      <Link to="/react-to-pdf">
        <button className="btn btn-error">Go Download PDF</button>
      </Link>

      <div className="grid md:grid-cols-2 gap-4 mt-6 mb-20">
        <div className="border p-2 rounded">
          ...
          <p>
            Uncontrolled component refer to components that manage their own
            state internally
          </p>
        </div>
        <div className="border p-2 rounded">
